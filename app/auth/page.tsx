...
export default function AuthPage() {
    ...
    return (
        <main className="flex min-h-screen items-center justify-center bg-[color:var(--background)] px-4 dark:bg-black">
            <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
                ...
                <form onSubmit={handleSubmit} className="mt-4 space-y-3 text-sm">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="mt-2 w-full rounded-full bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 disabled:opacity-60 dark:bg-zinc-100 dark:text-black dark:hover:bg-zinc-200"
                    >
                        {loading
                            ? "Обрабатываю..."
                            : mode === "signup"
